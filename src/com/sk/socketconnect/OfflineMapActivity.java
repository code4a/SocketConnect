...
//		initView();
	...
	private void initView() {
		...
		cidView = $(R.id.cityid);
		cityNameView = $(R.id.city);
		stateView = $(R.id.state);

		ListView hotCityList = $(R.id.hotcitylist);
		...
		ListView allCityList = $(R.id.allcitylist);
		// 获取所有支持离线地图的城市
		...
		LinearLayout cl = $(R.id.citylist_layout);
		LinearLayout lm = $(R.id.localmap_layout);
		...
		ListView localMapListView = $(R.id.localmaplist);
	...
	public class LocalMapAdapter extends BaseAdapter {
		...
		void initViewItem(View view, final MKOLUpdateElement e) {
			Button display = $(view, R.id.display);
			Button remove = $(view, R.id.remove);
			TextView title = $(view, R.id.title);
			TextView update = $(view, R.id.update);
			TextView ratio = $(view, R.id.ratio);
			...
			display.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					pBundle.putDouble("x", e.geoPt.longitude);
					pBundle.putDouble("y", e.geoPt.latitude);
