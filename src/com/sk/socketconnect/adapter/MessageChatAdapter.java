...
import com.sk.socketconnect.adapter.base.BaseListAdapter;
import com.sk.socketconnect.adapter.base.ViewHolder;
import com.sk.socketconnect.bean.JBmobMsg;
import com.sk.socketconnect.utils.FaceTextUtils;
import com.sk.socketconnect.utils.ImageLoadOptions;
...
/** ����������
  ...
  */
public class MessageChatAdapter extends BaseListAdapter<JBmobMsg> {
	...
	public MessageChatAdapter(Context context,List<JBmobMsg> msgList) {
	...
	public int getItemViewType(int position) {
		JBmobMsg msg = list.get(position);
...
//		}
	...
	private View createViewByType(JBmobMsg message, int position) {
...
//		}
	...
	public View bindView(final int position, View convertView, ViewGroup parent) {
		...
		final JBmobMsg item = list.get(position);
		if (convertView == null) {
...
//				||getItemViewType(position)==TYPE_SEND_IMAGE//ͼƬ��������
			...
			//״̬����
			if(item.getStatus()==JBmobConfig.STATUS_SEND_SUCCESS){//���ͳɹ�
				progress_load.setVisibility(View.INVISIBLE);
				iv_fail_resend.setVisibility(View.INVISIBLE);
				if(item.getMsgType()==JBmobConfig.TYPE_VOICE){
					tv_send_status.setVisibility(View.GONE);
					//tv_voice_length.setVisibility(View.VISIBLE);
				}else{
					tv_send_status.setVisibility(View.VISIBLE);
					tv_send_status.setText("sended");
				}
			}else if(item.getStatus()==JBmobConfig.STATUS_SEND_FAIL){//����������Ӧ���߲�ѯʧ�ܵ�ԭ����ɵķ���ʧ�ܣ�����Ҫ�ط�
				progress_load.setVisibility(View.INVISIBLE);
			...
			}else if(item.getStatus()==JBmobConfig.STATUS_SEND_RECEIVERED){//�Է��ѽ��յ�
				progress_load.setVisibility(View.INVISIBLE);
				iv_fail_resend.setVisibility(View.INVISIBLE);
				if(item.getMsgType()==JBmobConfig.TYPE_VOICE){
					tv_send_status.setVisibility(View.GONE);
					...
					tv_send_status.setVisibility(View.VISIBLE);
					tv_send_status.setText("readed");
				}
			}else if(item.getStatus()==JBmobConfig.STATUS_SEND_START){//��ʼ�ϴ�
		...
		case JBmobConfig.TYPE_IMAGE://ͼƬ��
//			try {
...
//			}
		...
		case JBmobConfig.TYPE_LOCATION://λ����Ϣ
//			try {
...
//			}
	...
	/** ��ȡͼƬ�ĵ�ַ--
	  ...
	  * @throws
	  */
//	private String getImageUrl(JBmobMsg item){
//		String showUrl = "";
...
//	}
	...
	/** ����ͼƬ
	  ...
	  * @throws
	  */
//	private void dealWithImage(int position,final ProgressBar progress_load,ImageView iv_fail_resend,TextView tv_send_status,ImageView iv_picture,JBmobMsg item){
//		String text = item.getContent();
//		if(getItemViewType(position)==TYPE_SEND_IMAGE){//���͵���Ϣ
//			if(item.getStatus()==JBmobConfig.STATUS_SEND_START){
//				progress_load.setVisibility(View.VISIBLE);
//				iv_fail_resend.setVisibility(View.INVISIBLE);
//				tv_send_status.setVisibility(View.INVISIBLE);
//			}else if(item.getStatus()==JBmobConfig.STATUS_SEND_SUCCESS){
//				progress_load.setVisibility(View.INVISIBLE);
//				iv_fail_resend.setVisibility(View.INVISIBLE);
//				tv_send_status.setVisibility(View.VISIBLE);
//				tv_send_status.setText("�ѷ���");
//			}else if(item.getStatus()==JBmobConfig.STATUS_SEND_FAIL){
//				progress_load.setVisibility(View.INVISIBLE);
//				iv_fail_resend.setVisibility(View.VISIBLE);
//				tv_send_status.setVisibility(View.INVISIBLE);
//			}else if(item.getStatus()==JBmobConfig.STATUS_SEND_RECEIVERED){
//				progress_load.setVisibility(View.INVISIBLE);
//				iv_fail_resend.setVisibility(View.INVISIBLE);
//				tv_send_status.setVisibility(View.VISIBLE);
